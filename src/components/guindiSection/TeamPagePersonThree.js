...
import "./TeamPage.css"
import thirdGuy from "../../images/Rectangle 239.svg"
import { useNavigate } from "react-router-dom";


function TeamPagePersonThree() {
    const navigate = useNavigate();
    const navigateNextCandidatThree = () =>{
        navigate('/teamMemberMemebrFour')
    }
        ...
        <div className="teamPage-text">
            ...
            <div className="friends-cointaner">
                <div className="teamPage-main-wrap">
                    <div className="team-first-line-wrap">
                        ...
                        <div className="team-first-line-right-wrap">
                            <img src={thirdGuy} alt="person-image" />
                        </div>
                    </div>
                ...
                <div className='team-next-button'>
                        <button className='next-button' onClick={navigateNextCandidatThree} >Next Candidate</button>
                    </div>
            </div>
...
export default TeamPagePersonThree;